    ...
    async function onSubmit(e) {
        ...
        async function storeImage(image) {
            return new Promise(async (resolve, reject) => {
                ...
                const storageRef = ref(storage, `knives/${filename}`);
        ...
        console.log("knifeDataCopy:", knifeDataCopy)
        console.log("==>images::", images)
        console.log("==>imgUrls::", imgUrls)
        console.log("==>knifeDataCopy.imgUrls::", knifeDataCopy.imgUrls)
        // console.log("==>knifeDataCopy.images2::",knifeDataCopy.images2)

        //RF?
        const docRef = await addDoc(collection(db, FB_COLLECTION_NAME), knifeDataCopy);

        setLoading(false)
        toast.success("Listing created.")
        navigate(`/knives/${docRef.id}`)
                        ...
                        <form onSubmit={onSubmit}>
                            ...
                            <div className="row my-3">
                                ...
                                <div>
                                    <div className="form-check form-check-inline">
                                        ...
                                        <label className="form-check-label" htmlFor="inlineRadio1">Folder</label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="radio" name="inlineRadioOptions"
                                               required
                                               id="knifeType" value="fixed" onChange={onChange}/>
                                        <label className="form-check-label" htmlFor="inlineRadio2">Fixed</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row my-3">
                                ...
                                <input value={model} onChange={onChange} className="form-control" id="model"
                                       name="model" type="text" placeholder="Sebenza L31" required minLength="2"
                                       maxLength="50"/>
                            ...
                            <div className="row my-3">
                                ...
                                <input value={bladeSteel} onChange={onChange} className="form-control" id="bladeSteel"
                                       type="text"
                                       required
                            ...
                            <div className="row my-3">
                                <label htmlFor="handleMaterial" className="form-label">Handle Material</label>
                            ...
                            <div className="row my-3">
                                <label htmlFor="bladeLength" className="form-label">Blade Length (inches)</label>
                                <input value={bladeLength} onChange={onChange} className="form-control" id="bladeLength"
                                       required
                                       type="number"
                                       min="0"
                                       max="9999"
                            ...
                            <div className="row my-3">
                                <label htmlFor="handleLength" className="form-label">Handle Length (inches)</label>
                            ...
                            <div className="row my-3">
                                <label htmlFor="overallLength" className="form-label">Overall Length (inches)</label>
                            ...
                            <div className="row my-3">
                                ...
                                <input value={weight} onChange={onChange} className="form-control" id="weight"
                                       type="number"
                                       min="0"
                                       max="5000"
                                       placeholder="oz."/>
                            ...
                            {enterAddress &&  <div className="row my-3">
                                <label
                                    htmlFor="description"
                                    className="form-label"
                                >Address</label>
